...
def output_prediction(pred, args):
    ...
    if args.show or args.katex:
        try:
            ...
            url = "https://katex.org/?data=" + quote(
                '{"displayMode":true,"leqno":false,"fleqn":false,"throwOnError":true,"errorColor":"#cc0000",\
"strict":"warn","output":"htmlAndMathml","trust":false,"code":"%s"}'
                % pred.replace("\\", "\\\\")
            )
            webbrowser.open(url)
