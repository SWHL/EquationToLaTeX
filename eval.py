...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-c", "--checkpoint", default=None, type=str, help="path to model checkpoint"
    )
    parser.add_argument(
        "-d",
        "--data",
        default="dataset/data/val.pkl",
        type=str,
    ...
    parser.add_argument(
        "-t", "--temperature", type=float, default=0.333, help="sampling emperature"
    )
    parser.add_argument(
        "-n",
        "--num-batches",
